...
export const STYLE_OPTIONS: VisualStyleOption[] = [
  {
    ...
    title: 'Cinematic Art',
    description:
      'Hyper-realistic lighting, wide aspect ratios, and dramatic compositions.',
    imageUrl:
  ...
  },
  {
    ...
    title: '2D Anime',
    description:
      'Vibrant colors, bold outlines, and expressive character designs.',
    imageUrl:
  ...
  },
  {
    ...
    title: 'Oil Painting',
    description:
      'Rich textures, visible brushstrokes, and classical lighting techniques.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Rough pencil lines, monochromatic shading, and artistic imperfection.',
    imageUrl:
...
export const STYLE_TONE_BY_ID: Record<VisualStyleId, string> = {
  cinematic_art: 'Cinematic',
  anime_2d: 'Anime Pulse',
  oil_painting: 'Orchestral',
  digital_sketch: 'Ambient',
};
