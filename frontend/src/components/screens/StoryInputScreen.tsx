      ...
      <main className="mx-auto flex w-full max-w-[1200px] flex-col px-6 pb-16 pt-10 lg:px-10">
        ...
        <div className="mx-auto mt-10 w-full max-w-[980px]">
          ...
          <div className="mt-10 flex items-center justify-end gap-6">
            ...
            <Button
              onClick={onNext}
              disabled={isPreparingMetaPrompt}
              variant="primary"
              size="md"
              startIcon={isPreparingMetaPrompt ? (
                <span className="material-symbols-outlined animate-spin text-base">progress_activity</span>
              ) : null}
              endIcon={isPreparingMetaPrompt ? null : <span className="material-symbols-outlined text-base">arrow_forward</span>}
            >
              {isPreparingMetaPrompt ? 'Generating prompt...' : 'Next: Meta Prompt'}
            </Button>
          </div>
        </div>
      </main>
