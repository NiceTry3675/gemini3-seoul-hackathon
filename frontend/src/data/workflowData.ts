...
export const STYLE_OPTIONS: VisualStyleOption[] = [
  {
    ...
    title: 'Webtoon Cel',
    description:
      '2D cel shading, crisp line art, Korean webtoon style, flat colors and high contrast.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Semi-realistic look with cinematic lighting, dramatic shadows and depth of field.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Soft pastel watercolor mood with fluid brush strokes and dreamy atmosphere.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'High-detail digital painting with rich color, thick brush texture and concept-art finish.',
    imageUrl:
...
export const STYLE_TONE_BY_ID: Record<VisualStyleId, string> = {
  ...
  watercolor_dream: 'Ambient',
  digital_masterpaint: 'Painterly',
};
